  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center text-sm mb-6 text-gray-500 dark:text-gray-400">
        ...
        <span className="text-gray-900 dark:text-gray-100">Quyền sở hữu trí tuệ</span>
      </div>

      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-50">Quyền sở hữu trí tuệ</h1>
        <div className="prose prose-blue dark:prose-invert max-w-none">
          ...
          <ul>
            <li>Bất kỳ việc bán hoặc sử dụng thương mại nào của Trang web hoặc nội dung của nó</li>
            <li>Bất kỳ việc sao chép, phân phối, trình diễn công khai hoặc sử dụng phái sinh nào</li>
            <li>
              Bất kỳ việc sử dụng kỹ thuật khai thác dữ liệu, robot hoặc các phương pháp thu thập và trích xuất dữ liệu
              tương tự
            </li>
            <li>Bất kỳ việc sử dụng Trang web hoặc nội dung của nó ngoài các chức năng được thiết kế</li>
            <li>
              Bất kỳ việc sử dụng nào có thể gây hại cho Trang web hoặc ảnh hưởng đến khả năng sử dụng của người khác
            </li>
          </ul>
          <p>
          ...
          <ul>
            <li>
              Chữ ký điện tử hoặc vật lý của người được ủy quyền hành động thay mặt cho chủ sở hữu quyền lợi độc quyền
              bị vi phạm
            </li>
            <li>Mô tả về tác phẩm có bản quyền mà bạn cho rằng đã bị vi phạm</li>
            <li>Mô tả về nội dung bạn cho là vi phạm và vị trí của nó trên Trang web</li>
            <li>Địa chỉ, số điện thoại và địa chỉ email của bạn</li>
            <li>
              Tuyên bố rằng bạn tin tưởng một cách thiện chí rằng việc sử dụng nội dung không được phép bởi chủ sở hữu
              bản quyền, đại diện của họ hoặc luật pháp
            </li>
            <li>
              Tuyên bố rằng thông tin trong thông báo của bạn là chính xác và, dưới hình phạt của tội khai man, bạn là
              chủ sở hữu bản quyền hoặc được ủy quyền hành động thay mặt cho chủ sở hữu bản quyền
            </li>
          </ul>
