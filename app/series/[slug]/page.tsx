...
import { getSeries, getArticlesBySeries } from "@/lib/data"
  ...
  if (!series) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="mb-8">Series bạn đang tìm kiếm không tồn tại hoặc đã bị xóa.</p>
        <Link
          href="/"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex items-center text-sm mb-6 text-gray-500 dark:text-gray-400">
        ...
        <Link href="/series" className="hover:text-primary-600 dark:hover:text-primary-400">
          Series
        </Link>
        <ChevronRight className="h-4 w-4 mx-1" />
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-2/3">
          ...
          <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-gray-50">Danh sách bài viết</h2>
                  ...
                  <div className="flex flex-col md:flex-row">
                    <div className="relative w-full md:w-1/3 aspect-video md:aspect-[4/3]">
                      ...
                      <div className="absolute top-2 left-2 bg-primary-600 text-white text-xs font-bold px-2 py-1 rounded">
                        Phần {article.seriesOrder || index + 1}/{articles.length}
                      </div>
                    </div>
