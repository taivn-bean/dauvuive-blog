...
export const metadata: Metadata = {
  title: "Giới thiệu - Đậu Vui Vẻ",
  description: "Giới thiệu về Đậu Vui Vẻ - Trang web về chăm sóc và nuôi dạy trẻ nhỏ",
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-50">Về Đậu Vui Vẻ</h1>
        ...
        <div className="prose prose-blue dark:prose-invert max-w-none">
          ...
          <p>
            Đậu Vui Vẻ ra đời với sứ mệnh cung cấp thông tin đáng tin cậy, khoa học và thực tiễn về chăm sóc và nuôi dạy
          ...
          <p>
            Đậu Vui Vẻ được thành lập vào năm 2020 bởi một nhóm các chuyên gia trong lĩnh vực y tế, giáo dục và tâm lý trẻ
          ...
          <p>
            Sau hơn 3 năm hoạt động, Đậu Vui Vẻ đã trở thành người bạn đồng hành đáng tin cậy của hàng trăm nghìn gia đình
          ...
          <ul>
            <li>
              <strong>Chính xác và khoa học:</strong> Mọi thông tin trên Đậu Vui Vẻ đều được nghiên cứu kỹ lưỡng, dựa trên
          ...
          <p>
            Đậu Vui Vẻ quy tụ đội ngũ chuyên gia đa dạng từ nhiều lĩnh vực khác nhau, bao gồm bác sĩ nhi khoa, chuyên gia
          ...
          <p>Đậu Vui Vẻ cung cấp thông tin toàn diện về các lĩnh vực:</p>
          <ul>
          ...
          <p>
            ...
            hợp tác, vui lòng liên hệ với chúng tôi qua email <a href="mailto:info@Đậu Vui Vẻ.vn">info@Đậu Vui Vẻ.vn</a> hoặc{" "}
