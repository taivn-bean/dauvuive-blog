...
export default function LatestArticles({ articles }: Readonly<{ articles: Article[] }>) {
  return (
      ...
      {articles.map((article) => (
        <article key={article.id} className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 dark:text-gray-400 line-clamp-2 mb-3">{article.description}</p>
