...
export default function ArticleActions({
  ...
  return (
    <div className={cn("flex items-center gap-4", className)}>
      <button
        className={cn("article-action-button", userVote === "upvote" && "active")}
      ...
      <button
        className={cn("article-action-button", userVote === "downvote" && "active")}
      ...
      <button className="article-action-button" onClick={handleCommentClick} aria-label="Bình luận">
        <MessageCircle className="h-4 w-4" />
        <span>{initialComments}</span>
      </button>

      <button className="article-action-button" onClick={handleShare} aria-label="Chia sẻ">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          <DropdownMenuItem onClick={handleReport}>Báo cáo bài viết</DropdownMenuItem>
          <DropdownMenuItem onClick={handleReport}>Báo cáo vi phạm bản quyền</DropdownMenuItem>
          <DropdownMenuItem onClick={handleReport}>Báo cáo nội dung không phù hợp</DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    </div>
  )
